...
<header>
            ...
            <div class="col tu-clase">
                ...
                <?php if (isset($_GET['success'])): ?>
                    <div id="mensaje" class="alert <?= $_GET['success'] === 'true' ? 'alert-success' : 'alert-danger'; ?>" role="alert">
                        <?= $_GET['success'] === 'true'
                            ? 'Datos del detalle de venta guardados correctamente.'
                            : 'Error al guardar los datos del detalle de venta.'; ?>
                    </div>
                <?php endif; ?>

                <form id="frmdetalle_venta" action="detalle_venta.php" method="post">
                    <tr>
                        <td></td>
                        <td>
                            <input id="idDetalle_venta" name="idDetalle_venta" type="hidden" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>idVentas:</td>
                        <td>
                            <input id="idVentas" name="idVentas" type="text" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>idProductos:</td>
                        <td>
                            <input id="idProductos" name="idProductos" type="text" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>Cantidad:</td>
                    ...
                    <button type="button" onclick="enviarFormulario('ConsultadetalleV.php')" class="btn btn-info btn-mini">Consultar</button>
                </form>
            </div>
    ...
    <script>
        function enviarFormulario(url) {
            ...
            var form = document.getElementById("frmdetalle_venta");
