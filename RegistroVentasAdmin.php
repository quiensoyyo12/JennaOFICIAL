...
<body>
            ...
            <div class="col tu-clase">
                ...
                <?php if (isset($_GET['success'])): ?>
                    <div id="mensaje" class="alert <?= $_GET['success'] === 'true' ? 'alert-success' : 'alert-danger'; ?>" role="alert">
                        <?= $_GET['success'] === 'true'
                            ? 'Datos de la venta guardados correctamente.'
                            : 'Error al guardar los datos de la venta.'; ?>
                    </div>
                <?php endif; ?>

                <form id="frmVentas" action="RegistroVentas.php" method="post">
                    <tr>
                        <td></td>
                        <td>
                            <input id="idVentas" name="idVentas" type="hidden" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>Total:</td>
                        <td>
                            <input id="total" name="total" type="number" class="form-control" placeholder="total">
                        </td>
                    </tr>
                    <tr>
                        <td>Fecha:</td>
                        <td>
                            <input id="Fecha_venta" name="Fecha_venta" type="date" class="form-control" placeholder="fecha">
                        </td>
                    </tr>
                    <br>
                    <tr>
                    ...
                    <button type="button" onclick="enviarFormulario('ConsultasVentas.php')" class="btn btn-info btn-mini">Consultar</button>
                </form>
            </div>
    ...
    <script>
        function enviarFormulario(url) {
            ...
            var form = document.getElementById("frmVentas");
