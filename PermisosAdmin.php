    ...
    <div class="container text-center">
        <div class="row">
            ...
            <div class="col tu-clase">
                <h2>Datos de los permisos</h2>
                <form id="frmPermisos" action="Permisos.php" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="Reportes" name="Reportes" type="text" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input id="Consultas" name="Consultas" type="text" class="form-control">
                        </td>
                    </tr>
                    ...
                    <!-- Botón para eliminar -->
                    <!-- <button type="button" onclick="enviarFormulario('Eliminarpermisos.php')" class="btn btn-danger btn-mini">Eliminar</button> -->
                    <!-- Botón para actualizar -->
                    <!-- <button type="button" onclick="enviarFormulario('Updatepermisos.php')" class="btn btn-success btn-mini">Actualizar</button> -->
                    <!-- Botón para consultar -->
                    <button type="button" onclick="enviarFormulario('Consultapermisos.php')" class="btn btn-info btn-mini">Consultar</button>
                </form>
            </div>
