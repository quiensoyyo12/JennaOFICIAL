...
<head>
    ...
    <title>Eliminación de permisos</title>
</head>
<body>
    <div class="container text-center">
        <div class="row">
            ...
            <div class="col-6">
                ...
                ?>
                <a href="ConsultaVentas.php" class="btn btn-outline-primary">Consulta la Base de Datos de Ventas</a>
            </div>
            <div class="col">
            </div>
        </div>
