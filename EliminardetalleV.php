    ...
    <div class="container text-center">
        <div class="row">
            ...
            <div class="col-6">
                ...
                $consulta = "DELETE FROM detalle_venta WHERE idDetalle_venta='$idDetalle_venta'";
                ...
                ?>
                <a href="ConsultadetalleV.php" class="btn btn-outline-primary">Consulta la Base de Datos de Ventas</a>
            </div>
            <div class="col">
            </div>
        </div>
