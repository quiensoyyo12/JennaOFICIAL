...
<body>
            ...
            <div class="col tu-clase">
                ...
                <?php if (isset($_GET['success'])): ?>
                    <div id="mensaje" class="alert <?= $_GET['success'] === 'true' ? 'alert-success' : 'alert-danger'; ?>" role="alert">
                        <?= $_GET['success'] === 'true'
                            ? 'Datos del proveedor guardados correctamente.'
                            : 'Error al guardar los datos del proveedor.'; ?>
                    </div>
                <?php endif; ?>

                <form id="frmProveedor" action="RegistroProveedor.php" method="post">
                    <tr>
                        <td></td>
                        <td><input id="idProveedor" name="idProveedor" type="hidden" class="form-control"></td>
                    </tr>
                    <tr>
                        <td>Nombre:</td>
                        <td><input id="Nombre" name="Nombre" type="text" class="form-control"></td>
                    </tr>
                    <tr>
                        <td>Apellido Paterno:</td>
                        <td><input id="ApellidoP" name="ApellidoP" type="text" class="form-control"></td>
                    </tr>
                    <tr>
                        <td>Apellido Materno:</td>
                        <td><input id="ApellidoM" name="ApellidoM" type="text" class="form-control"></td>
                    </tr>
                    <tr>
                        <td>RFC:</td>
                        <td><input id="RFC" name="RFC" input type="text" class="form-control"></td>
                    </tr>
                    <tr>
                        <td>Teléfono:</td>
                        <td><input id="Telefono" name="Telefono" type="number" class="form-control"></td>
                    </tr>
                    <tr>
                        <td>Domicilio:</td>
                    ...
                    <tr>
                        <td>Correo:</td>
                        <td><input id="Correo" name="Correo" type="email" class="form-control"></td>
                    </tr>
                    <br>
                    <tr>
                        <td>
                            <input id="Registrar" name="Registrar" type="submit" value="Registrar" class="btn btn-primary btn-mini">
                        </td>
                        <td>
                            <input id="Borrar" type="reset" value="Borrar" class="btn btn-danger btn-mini">
                        </td>
                    </tr>
                    <button type="button" onclick="enviarFormulario('Consultaproveedor.php')" class="btn btn-info btn-mini">Consultar</button>
                </form>
            </div>
    ...
    <script>
        function enviarFormulario(url) {
            ...
            var form = document.getElementById("frmProveedor");
