...
<head>
    ...
    <title>Eliminación de pedido</title>
</head>
<body>
    <div class="container text-center">
        <div class="row">
            ...
            <div class="col-6">
                ...
                $consulta = "DELETE FROM detalle_pedido WHERE idDetalle_pedido='$idDetalle_pedido'";
                ...
                ?>
                <a href="ConsultaDetalleP.php" class="btn btn-outline-primary">Consulta la Base de Datos de pedido</a>
            </div>
            <div class="col">
            </div>
        </div>
