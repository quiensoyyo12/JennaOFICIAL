        ...
        <div class="row">
            ...
            <div class="col tu-clase">
                ...
                <form id="frmPedidos" action="Pedidos.php" method="post">
                    ...
                    <tr>
                        <td>
                            <input type="submit" id="Guardar" name="Guardar" value="Guardar" class="btn btn-primary btn-mini">
                        </td>
                        <td>
                            <button id="Borrar" type="reset" value="Borrar" class="btn btn-danger btn-mini">Borrar</button>
                        </td>
                    </tr>
                    <button type="button" onclick="enviarFormulario('Consultapedidos.php')" class="btn btn-info btn-mini">Consultar</button>
                </form>
            </div>
