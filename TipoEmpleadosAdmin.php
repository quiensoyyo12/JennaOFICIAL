    ...
    <script src="script2.js"></script>
        ...
        <div class="row">
            ...
            <div class="col tu-clase">
                        ...
                        <form id="frmTiposEmpleados" action="TiposEmpleados.php" method="post">
                            <tr>
                                <td>
                                    
                                </td>
                                <td>
                                    <input id="idTiposEmp" name="idTiposEmp" type="hidden" class="form-control">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input id="Administrador" name="Administrador" type="text" class="form-control">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input id="Auxiliar" name="Auxiliar" type="text" class="form-control">
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="idPermisos" name="idPermisos" type="text" class="form-control">
                                </td>
                            </tr>
                            <br>
                            <tr>
                                ...
                                <td>
                                    <input id="Borrar" type="reset" value="Eliminar" class="btn btn-danger btn-mini">
                                </td>

                            </tr>
                            <!-- Botón para eliminar -->
                            <!-- <button type="button" onclick="enviarFormulario('EliminarTipo.php')"
                                class="btn btn-danger btn-mini">Eliminar</button> -->
                            <!-- Botón para actualizar -->
                            <!-- <button type="button" onclick="enviarFormulario('Updatetipo.php')"
                                class="btn btn-success btn-mini">Actualizar</button> -->
                            <!-- Botón para consultar -->
                            <button type="button" onclick="enviarFormulario('Consultatipo.php')"
        ...
        <script>
            function enviarFormulario(url) {
                ...
                var form = document.getElementById("frmTiposEmpleados");
